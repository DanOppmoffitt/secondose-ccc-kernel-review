...
class CollapsedConeDoseEngine(DoseEngineBase):
    ...
    def compute_dose(
        ...
        **kwargs: Any,
        ...
        use_depth_dependent_mu : bool, optional (kwarg)
            Research-only TERMA hardening switch. Defaults to False.
        mu_0_per_mm, mu_inf_per_mm, z_h_mm : float, optional (kwargs)
            Depth-dependent attenuation parameters used only when
